...
describe('schema parity sqlite ↔ pg', () => {
  ...
  it('every pg transaction table has server_received_at', () => {
    const txTables = ['purchase', 'purchase_line', 'production_batch', 'stock_count', 'stock_count_line', 'stock_adjustment', 'stock_movement', 'shift', 'cash_movement', 'cash_count', 'z_report', 'order', 'order_line', 'payment', 'discount', 'order_event', 'order_payment_intent']
