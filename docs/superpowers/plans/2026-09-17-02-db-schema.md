...
จำนวนเทสต์ของ `@dayo/db-schema` หลังแต่ละ task (ใช้ตรวจว่าไม่มีเทสต์หาย): Task 1 = 20 · Task 2 = 28 · Task 3 = 38 · Task 4 = 40 · Task 5 = 42 · Task 6 = 48
...
Expected: ทุกแพ็กเกจผ่าน — contracts 5 · domain 75 · excel-import 33 · db-schema 48 (รวม 161) · ขั้นตอนเดียวกับ `.github/workflows/ci.yml`
